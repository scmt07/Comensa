  ...
  <div class="item">
    <div class="content">
      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        <label for="Cadastro">Adicionar Crédito</label><br>
        ...
        <div class="input-group">
          <button type="submit" onclick="return confirm('Adicionar crédito?');" name="action" value="login" class="btn btn-primary">Adicionar</button>
        </div>
